...
$solicitudesPtObj = new pullhistorialDespachos();
$dataSolPt = array('opcion' => 0,'cliente_id' => $_SESSION["CLIENTE_ID"] ,'usuario_id'=> $_SESSION["USUARIO_ID"],'solicitante_id'=>7224034);
$dataObtenerSol = $solicitudesPtObj->sp_B2BHistorialDespachos($dataSolPt);//sp_B2BPullticketTokens Esta es una función y debe estar definida en una clase en MODELS 
...
/*****************Carga en vista*************************************/
$oTpl->loadInicio(FS_DESPACHOS.'/historial-despachos.html');
$oTpl->setVar(
    array(
